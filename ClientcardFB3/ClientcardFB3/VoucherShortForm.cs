...
namespace ClientcardFB3
{
    public partial class VoucherShortForm : Form
    {
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    while (reader.Read())
                    {
                        ...
                        {
                            addVoucherButton(iType, lvItem, reader.GetInt32(8), reader.GetInt32(7), reader.GetInt32(9));
                        }
                    }
                }
                SQLConn.Close();
        ...
        private void addVoucherButton(int iType, ListViewItem lvi, int iRow, int iCol, int backcolor)
        {
